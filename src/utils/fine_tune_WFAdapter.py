...
def run_train(
    ...
    if language.lower() == "myspeech":
        output_dir = "../../weights/MySpeechASR/fine_tune_WFAdapter"
    else:
        output_dir = "../../weights/KeSpeechASR/fine_tune_WFAdapter"
    ...
    training_args = TrainingArguments(
        ...
        save_steps=1000, eval_steps=3000, evaluation_strategy="steps", save_total_limit=1,
...
if __name__ == "__main__":
    ...
    pretrain_model_dir = "../../weights/wav2vec2_zhCN"
    pretrain_model_weight_path = "../../models/adapted_wav2vec/wav2vec_wf_adapter_pro.pt"
