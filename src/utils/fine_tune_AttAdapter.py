...
from src.utils.result.best import save_if_best, get_best
...
def run_train(
    ...
    if language.lower() == "myspeech":
        output_dir = "../../weights/MySpeechASR/fine_tune_AttAdapter"
    else:
        output_dir = "../../weights/KeSpeechASR/fine_tune_AttAdapter"
    ...
    training_args = TrainingArguments(
        ...
        , learning_rate=1e-4, warmup_steps=10000, warmup_ratio=0.1, eval_steps=3000, save_steps=1000,
        save_total_limit=1, label_names=["labels"],
    ...
    dialect_feature = torch.tensor(torch.load(dialectFeaturePath)).cuda()
...
if __name__ == "__main__":
    ...
    KeSpeech_dataset_json_path = "../../weights/KeSpeechASR/KeSpeechDataset_shrinked.json"
    processor = make_processor(True, "../../weights/MySpeechASR")
    ...
    pretrain_model_weight_path = "../../models/ctc_aid/wav2vec_ctc_ecapa_aid_pro.pt"
    ...
    run_train(
        ...
        dialectFeaturePath=dialect_feature_path,
        language="MySpeech",
        fine_tune_stage=1,
    )
